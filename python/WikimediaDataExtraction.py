...
#PATH_WIKI_XML = 'ContentStation/'
#FILENAME_WIKI = 'thewiki.us-07_14_2021-18_09_04.xml'
FILENAME_WIKI = 'enwiki-20210801-pages-articles-multistream.xml'
PATH_WIKI_XML = 'WikiContent/'
...
print ('Start Processing MediaWiki formated XML')
